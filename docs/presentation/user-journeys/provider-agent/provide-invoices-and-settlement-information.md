...
sidebar_label: "Provide invoices and settlement information"
description: "Supply the commercial records needed to validate charges and settle completed stays."
---

# Provide invoices and settlement information

**Primary actor:** Accommodation Provider Agent<br />
**Outcome:** Supply the commercial records needed to validate charges and settle completed stays.
...
- Generate or retrieve the invoice for the completed, cancelled, or no-show stay.
- Include booking references, taxes, fees, credits, and payment terms.
- Submit the invoice through the agreed commercial channel.
- Respond to bill-validation questions or issue a correction or credit note.
- Track the invoice through accepted, disputed, and settled states.
...
```plantuml-image
../../diagrams/user-journeys/provider-agent/provide-invoices-and-settlement-information/01-end-to-end-interaction.puml | Accommodation Provider Agent — Provide invoices and settlement information — End-to-end interaction
```
...
|---|---|---|---|---|
| `POST` | `/provider-api/v1/invoices` | Submit invoice, tax, fee, credit, and settlement information. | Provider Billing Service<br/>Existing commercial integration / ESB | Required: providerInvoiceNumber |
...
{
  "requestId": "01JEXAMPLE...",
  "id": "provide-invoices-and-settlement-information-123",
  "status": "accepted",
  "version": 8,
