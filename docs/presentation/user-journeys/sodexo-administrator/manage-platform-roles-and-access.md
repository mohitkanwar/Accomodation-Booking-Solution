...
sidebar_label: "Manage platform roles and access"
...
**Outcome:** Control privileged access across corporate, operator, and Sodexo responsibilities.
...
- Review users, service accounts, role assignments, and effective scopes.
- Grant, modify, expire, or revoke access under least-privilege rules.
- Enforce segregation of duties for approval, booking, billing, and administration.
- Review dormant and high-risk access periodically.
- Preserve every privileged access change for audit.
...
```plantuml-image
../../diagrams/user-journeys/sodexo-administrator/manage-platform-roles-and-access/01-end-to-end-interaction.puml | Sodexo Administrator — Manage platform roles and access — End-to-end interaction
```
...
|---|---|---|---|---|
| `GET` | `/api/v1/platform/access-assignments` | List privileged users, service accounts, roles, and scopes. | Access Control Service | Not required |
| `POST` | `/api/v1/platform/access-assignments/commands` | Grant, modify, expire, or revoke privileged access. | Access Control Service | Required: commandId |
...
`POST /api/v1/platform/access-assignments/commands`.
...
{
  "requestId": "01JEXAMPLE...",
  "id": "manage-platform-roles-and-access-123",
  "status": "accepted",
  "version": 8,
  "occurredAt": "2026-07-25T12:00:00Z",
  "links": {
    "self": "/api/v1/platform/access-assignments/commands",
    "allowedActions": [
      "view"
    ]
  }
