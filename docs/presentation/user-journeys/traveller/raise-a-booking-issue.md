---
title: "Raise a booking issue"
sidebar_label: "Raise a booking issue"
description: "Create a traceable support case for a confirmed or attempted booking."
---

# Raise a booking issue

**Primary actor:** Traveller<br />
**Outcome:** Create a traceable support case for a confirmed or attempted booking.
...
```plantuml-image
../../diagrams/user-journeys/traveller/raise-a-booking-issue/01-end-to-end-interaction.puml | Traveller — Raise a booking issue — End-to-end interaction
```
...
| `POST` | `/api/v1/bookings/{bookingId}/issues` | Open a support case linked to the booking and evidence. | Booking Workflow Service | Required: Idempotency-Key |
...
{
  "requestId": "01JEXAMPLE...",
  "id": "raise-a-booking-issue-123",
  "status": "accepted",
  "version": 8,
  "occurredAt": "2026-07-25T12:00:00Z",
  "links": {
    "self": "/api/v1/bookings/resource-123/issues",
    "allowedActions": [
      "view"
    ]
  }
