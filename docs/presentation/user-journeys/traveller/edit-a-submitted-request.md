---
title: "Edit a submitted request"
sidebar_label: "Edit a submitted request"
description: "Change an editable request and return it through policy evaluation and approval."
---

# Edit a submitted request

**Primary actor:** Traveller<br />
**Outcome:** Change an editable request and return it through policy evaluation and approval.
...
### 1. Load and edit the request

```plantuml-image
../../diagrams/user-journeys/traveller/edit-a-submitted-request/01-load-and-edit-the-request.puml | Traveller — Edit a submitted request — Load and edit the request
```

### 2. Re-evaluate and resubmit

```plantuml-image
../../diagrams/user-journeys/traveller/edit-a-submitted-request/02-re-evaluate-and-resubmit.puml | Traveller — Edit a submitted request — Re-evaluate and resubmit
```
...
| `PATCH` | `/api/v1/booking-requests/{requestId}` | Update editable trip or accommodation requirements using optimistic locking. | Booking Workflow Service | Required: expectedVersion |
| `POST` | `/api/v1/booking-requests/{requestId}/submit` | Re-evaluate policy and return the edited request to approval. | Booking Workflow Service | Required: commandId |
...
`POST /api/v1/booking-requests/{requestId}/submit`.
...
```json
{
  ...
  "expectedVersion": 7,
  "journey": "edit-a-submitted-request",
  "resourceId": "resource-123",
  "action": "Re-evaluate policy and return the edited request to approval",
  "data": {
...
{
  "requestId": "01JEXAMPLE...",
  "id": "edit-a-submitted-request-123",
  "status": "accepted",
  "version": 8,
  "occurredAt": "2026-07-25T12:00:00Z",
  "links": {
    "self": "/api/v1/booking-requests/resource-123/submit",
    "allowedActions": [
      "view"
    ]
  }
