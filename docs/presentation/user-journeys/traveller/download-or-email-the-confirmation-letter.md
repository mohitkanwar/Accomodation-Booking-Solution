---
title: "Download or email the confirmation letter"
sidebar_label: "Download or email the confirmation letter"
description: "Obtain an authorised confirmation document and optionally send it by email."
---

# Download or email the confirmation letter

**Primary actor:** Traveller<br />
**Outcome:** Obtain an authorised confirmation document and optionally send it by email.
...
### 1. Authorise and generate confirmation

```plantuml-image
../../diagrams/user-journeys/traveller/download-or-email-the-confirmation-letter/01-authorise-and-generate-confirmation.puml | Traveller — Download or email the confirmation letter — Authorise and generate confirmation
```

### 2. Deliver confirmation by email

```plantuml-image
../../diagrams/user-journeys/traveller/download-or-email-the-confirmation-letter/02-deliver-confirmation-by-email.puml | Traveller — Download or email the confirmation letter — Deliver confirmation by email
```
...
| `GET` | `/api/v1/bookings/{bookingId}/confirmation` | Generate or retrieve the authorised confirmation document. | Booking Workflow Service | Not required |
| `POST` | `/api/v1/bookings/{bookingId}/confirmation/email` | Queue a confirmation email to an authorised recipient. | Booking Workflow Service | Deduplicate booking, recipient, and document version |
...
`POST /api/v1/bookings/{bookingId}/confirmation/email`.
...
```json
{
  ...
  "expectedVersion": 7,
  "journey": "download-or-email-the-confirmation-letter",
  "resourceId": "resource-123",
  "action": "Queue a confirmation email to an authorised recipient",
  "data": {
...
{
  "requestId": "01JEXAMPLE...",
  "id": "download-or-email-the-confirmation-letter-123",
  "status": "accepted",
  "version": 8,
  "occurredAt": "2026-07-25T12:00:00Z",
  "links": {
    "self": "/api/v1/bookings/resource-123/confirmation/email",
    "allowedActions": [
      "view"
    ]
  }
