---
title: "Follow up on a request awaiting approval"
sidebar_label: "Follow up on a request awaiting approval"
description: "Send a controlled reminder without creating notification spam."
---

# Follow up on a request awaiting approval

**Primary actor:** Traveller<br />
**Outcome:** Send a controlled reminder without creating notification spam.
...
```plantuml-image
../../diagrams/user-journeys/traveller/follow-up-on-a-request-awaiting-approval/01-end-to-end-interaction.puml | Traveller — Follow up on a request awaiting approval — End-to-end interaction
```
...
| `POST` | `/api/v1/booking-requests/{requestId}/reminders` | Create a throttled approval reminder and notification event. | Booking Workflow Service | One active reminder per configured interval |
...
`POST /api/v1/booking-requests/{requestId}/reminders`.
...
```json
{
  ...
  "expectedVersion": 7,
  "journey": "follow-up-on-a-request-awaiting-approval",
  "resourceId": "resource-123",
  "action": "Create a throttled approval reminder and notification event",
  "data": {
...
{
  "requestId": "01JEXAMPLE...",
  "id": "follow-up-on-a-request-awaiting-approval-123",
  "status": "accepted",
  "version": 8,
  "occurredAt": "2026-07-25T12:00:00Z",
  "links": {
    "self": "/api/v1/booking-requests/resource-123/reminders",
    "allowedActions": [
      "view"
    ]
  }
