...
sidebar_label: "View and manage the approval queue"
...
**Outcome:** Find requests raised by travellers within the approver's authorised organisational scope.
...
- Open the list of requests awaiting a decision.
- Filter by traveller, destination, travel date, policy status, or request age.
- Prioritise urgent and soon-to-expire accommodation offers.
- Open a request while preserving the queue position and current filters.
...
```plantuml-image
../../diagrams/user-journeys/approver/view-and-manage-the-approval-queue/01-end-to-end-interaction.puml | Approver — View and manage the approval queue — End-to-end interaction
```
...
|---|---|---|---|---|
| `GET` | `/api/v1/approvals?status=pending` | List actionable requests within the approver’s organisational scope. | Booking Workflow Service | Not required |
...
`GET /api/v1/approvals/{approvalId}/context`.
...
```json
{
  ...
  "expectedVersion": 7,
  "journey": "view-and-manage-the-approval-queue",
  "resourceId": "resource-123",
  "action": "Return request, offer, policy, conversation, and authority evidence",
  "data": {
...
{
  "requestId": "01JEXAMPLE...",
  "id": "view-and-manage-the-approval-queue-123",
  "status": "available",
  "version": 7,
  "occurredAt": "2026-07-25T12:00:00Z",
  "links": {
    "self": "/api/v1/approvals/resource-123/context",
    "allowedActions": [
      "continue"
    ]
  }
