...
![Multiple accommodation seeker and provider corporations with their associated users](./corporate-user-landscape.drawio.svg)
...
```plantuml-image
./traveller-journey-4-view-requests.puml | Traveller journey — view submitted requests
```

**Traveller journey 5 · Follow up on a request awaiting approval**

```plantuml-image
./traveller-journey-5-follow-up.puml | Traveller journey — follow up on a request awaiting approval
```
...
```plantuml-image
./approver-journey-1-manage-queue.puml | Approver journey — view and manage the approval queue
```
...
```plantuml-image
./approver-journey-2-review-request.puml | Approver journey — review an accommodation request
```
...
```plantuml-image
./approver-journey-3-approve-request.puml | Approver journey — approve a request
```
...
```plantuml-image
./approver-journey-4-reject-request.puml | Approver journey — reject a request
```
...
```plantuml-image
./approver-journey-5-seek-clarification.puml | Approver journey — seek clarification and resume the decision
```
...
```plantuml-image
./approver-journey-6-reassess-offer.puml | Approver journey — reassess a materially changed offer
```
...
```plantuml-image
./corporate-admin-journey-1-manage-policies.puml | Corporate Administrator journey — manage travel policies
```
...
```plantuml-image
./corporate-admin-journey-2-manage-roles.puml | Corporate Administrator journey — manage corporate roles and assignments
```
...
```plantuml-image
./corporate-admin-journey-3-manage-destinations.puml | Corporate Administrator journey — manage destinations and corporate sites
```
...
```plantuml-image
./corporate-admin-journey-4-manage-price-ranges.puml | Corporate Administrator journey — manage price ranges and exceptions
```
...
```plantuml-image
./corporate-admin-journey-5-validate-bills.puml | Corporate Administrator journey — validate accommodation bills
```
...
```plantuml-image
./corporate-admin-journey-6-approve-payments.puml | Corporate Administrator journey — approve and make payments
```
...
```plantuml-image
./corporate-admin-journey-7-review-reports.puml | Corporate Administrator journey — review spend, compliance, and audit reports
```
...
```plantuml-image
./booking-operator-journey-1-manage-queue.puml | Booking Operator journey — manage the booking work queue
```
...
```plantuml-image
./booking-operator-journey-2-create-booking.puml | Booking Operator journey — validate and create a booking
```
...
```plantuml-image
./booking-operator-journey-3-handle-changed-offer.puml | Booking Operator journey — handle a changed price or unavailable offer
```
...
```plantuml-image
./booking-operator-journey-4-resolve-failed-booking.puml | Booking Operator journey — resolve a failed or uncertain booking
```
...
```plantuml-image
./booking-operator-journey-5-amend-cancel-reservation.puml | Booking Operator journey — amend or cancel a reservation
```
...
```plantuml-image
./booking-operator-journey-6-create-on-behalf.puml | Booking Operator journey — create a request on behalf of a traveller
```
...
```plantuml-image
./booking-operator-journey-7-investigate-issue.puml | Booking Operator journey — investigate a booking issue
```
...
```plantuml-image
./sodexo-admin-journey-1-onboard-tenant.puml | Sodexo Administrator journey — onboard and maintain a corporate tenant
```
...
```plantuml-image
./sodexo-admin-journey-2-manage-access.puml | Sodexo Administrator journey — manage platform roles and access
```
...
```plantuml-image
./sodexo-admin-journey-3-configure-integrations.puml | Sodexo Administrator journey — configure supplier integrations
```
...
```plantuml-image
./sodexo-admin-journey-4-monitor-operations.puml | Sodexo Administrator journey — monitor booking and approval operations
```
...
```plantuml-image
./sodexo-admin-journey-5-resolve-reconciliation.puml | Sodexo Administrator journey — resolve reconciliation exceptions
```
...
```plantuml-image
./sodexo-admin-journey-6-generate-reports.puml | Sodexo Administrator journey — generate operational and audit reports
```
...
```plantuml-image
./sodexo-admin-journey-7-support-investigation.puml | Sodexo Administrator journey — support a controlled investigation
```
...
```plantuml-image
./provider-agent-journey-1-manage-configuration.puml | Accommodation Provider Agent journey — manage accommodation configuration
```
...
```plantuml-image
./provider-agent-journey-2-fulfil-reservation.puml | Accommodation Provider Agent journey — receive and fulfil a reservation
```
...
```plantuml-image
./provider-agent-journey-3-process-amendment.puml | Accommodation Provider Agent journey — process an amendment or cancellation
```
...
```plantuml-image
./provider-agent-journey-4-provide-support.puml | Accommodation Provider Agent journey — provide booking support
```
...
```plantuml-image
./provider-agent-journey-5-provide-invoices.puml | Accommodation Provider Agent journey — provide invoices and settlement information
```
...
```plantuml-image
./provider-agent-journey-6-resolve-discrepancy.puml | Accommodation Provider Agent journey — resolve a reconciliation discrepancy
```
